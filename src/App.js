...
const WEATHER_THEMES = {
  Clear: {
    gradient: "linear-gradient(135deg, #0f4c81 0%, #1a6eb5 40%, #f7971e 100%)",
    particle: "☀️",
    accent: "#f7c948",
    label: "ท้องฟ้าแจ่มใส",
  },
  Clouds: {
    gradient: "linear-gradient(135deg, #1c2f4a 0%, #3d6b8e 50%, #8aadca 100%)",
    particle: "☁️",
    accent: "#90caf9",
    label: "มีเมฆ",
  },
  Rain: {
    gradient: "linear-gradient(135deg, #0d1b2a 0%, #1b3a5c 50%, #2d6a9f 100%)",
    particle: "🌧️",
    accent: "#64b5f6",
    label: "ฝนตก",
  },
  Drizzle: {
    gradient: "linear-gradient(135deg, #1c2f4a 0%, #2d5a7a 50%, #4a8fa8 100%)",
    particle: "🌦️",
    accent: "#81d4fa",
    label: "ฝนปรอย",
  },
  ...
  Snow: {
    gradient: "linear-gradient(135deg, #1a2a4a 0%, #3d6b8e 50%, #b0d4e8 100%)",
    particle: "❄️",
    accent: "#e3f2fd",
    label: "หิมะตก",
  },
  Mist: {
    gradient: "linear-gradient(135deg, #1c2a38 0%, #3d5a72 50%, #7a9bb5 100%)",
    particle: "🌫️",
    accent: "#b0bec5",
    label: "หมอก",
  },
